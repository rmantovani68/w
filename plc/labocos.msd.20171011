CONFIGURATION LABOCOS_CONTROL
 ...
 VAR_GLOBAL
	...
	FCB3 AT %IXIOS.0.0.16.0.54 : BOOL:= 0;
	FCB4 AT %IXIOS.0.0.16.0.53 : BOOL:= 0;
	FCB5 AT %IXIOS.0.0.16.0.52 : BOOL:= 0;
	FCB6 AT %IXIOS.0.0.16.0.51 : BOOL:= 0;
	FCC AT %IXIOS.0.0.16.0.27 : BOOL:= 0;  (* fotocellula spintore bilancia *)
	FCD AT %IXIOS.0.0.16.0.42 : BOOL:= 0;  (* fot. pieno accumulo bollini bianchi *)
	FCE AT %IXIOS.0.0.16.0.38 : BOOL:= 0;
	FCH AT %IXIOS.0.0.16.0.43 : BOOL:= 0;  (* fot. pieno *)
	FCI AT %IXIOS.0.0.16.0.40 : BOOL:= 0;
	FCL AT %IXIOS.0.0.16.0.70 : BOOL:= 0;  (* fot. pieno friz. MM *)
	FCM AT %IXIOS.0.0.16.0.69 : BOOL:= 0;
	FCN AT %IXIOS.0.0.16.0.71 : BOOL:= 0;  (* fot. di testa uscita nastratrice *)
	FCO AT %IXIOS.0.0.16.0.73 : BOOL:= 0;
	FCP AT %IXIOS.0.0.16.0.66 : BOOL:= 0;  (* fot. di testa traslaz. a monte del plz *)
	FCPLZ AT %IXIOS.0.0.16.0.83 : BOOL:= 0;
	FCQ AT %IXIOS.0.0.16.0.72 : BOOL:= 0;
	FCS AT %IXIOS.0.0.16.0.48 : BOOL:= 0;  (* fotocellula che sente se il nastro del PLZ e' in moto *)
	FCT AT %IXIOS.0.0.16.0.50 : BOOL:= 0;  (* pieno friz. isola2 *)
	FCU AT %IXIOS.0.0.16.0.49 : BOOL:= 0;
	FCZ AT %IXIOS.0.0.16.0.35 : BOOL:= 0;
	FEM AT %IXIOS.0.0.16.0.41 : BOOL:= 0;
	FSC AT %IXIOS.0.0.16.0.84 : BOOL:= 0;  (* fot. abilitaz. scanner PLZ *)
	INAL AT %IXIOS.0.0.16.0.23 : BOOL:= 0;  (* alimentazione sezionata presente *)
	PAIS2 AT %IXIOS.0.0.16.0.4 : BOOL:= 0;  (* PS ARRESTO ISOLA2 *)
	PAMAR3 AT %IXIOS.0.0.16.0.7 : BOOL:= 0;  (* pulsante arresto *)
	...
	SEA AT %IXIOS.0.0.16.0.32 : BOOL:= 0;  (* mc. pistone scarto avanti *)
	SEB AT %IXIOS.0.0.16.0.20 : BOOL:= 0;  (* selettore esclusione bilancia *)
	SEI AT %IXIOS.0.0.16.0.39 : BOOL:= 0;  (* mc. pistone scarto ind. *)
	SELALTO AT %IXIOS.0.0.16.0.64 : BOOL:= 0;  (* selettore nastro alto *)
	SELBASS AT %IXIOS.0.0.16.0.65 : BOOL:= 0;  (* selettore nastro basso *)
	SIA AT %IXIOS.0.0.16.0.67 : BOOL:= 0;
	SII AT %IXIOS.0.0.16.0.56 : BOOL:= 0;
	SLPLZ AT %IXIOS.0.0.16.0.81 : BOOL:= 0;
	...
	ACCIS2 AT %QXIOS.0.0.16.0.137 : BOOL:= 0;  (* lampada rossa lampeggiante su soppalco *)
	...
	C29 AT %QXIOS.0.0.16.0.154 : BOOL:= 0;  (* motore centralina idraulica ELEVATORE *)
	DPLZ AT %QXIOS.0.0.16.0.193 : BOOL:= 0;
	...
	EVE AT %QXIOS.0.0.16.0.132 : BOOL:= 0;  (* spintore *)
	...
	M31 AT %QXIOS.0.0.16.0.149 : BOOL:= 0;
	M32 AT %QXIOS.0.0.16.0.150 : BOOL:= 0;
	M33 AT %QXIOS.0.0.16.0.151 : BOOL:= 0;
	M9 AT %QXIOS.0.0.16.0.178 : BOOL:= 0;
	MA AT %QXIOS.0.0.16.0.177 : BOOL:= 0;
	MB AT %QXIOS.0.0.16.0.152 : BOOL:= 0;
	MC AT %QXIOS.0.0.16.0.131 : BOOL:= 0;  (* motore nastro basculante *)
	ME AT %QXIOS.0.0.16.0.181 : BOOL:= 0;  (* mot. pareggiatore *)
	MF AT %QXIOS.0.0.16.0.185 : BOOL:= 0;  (* motore scarto *)
	...
	ML AT %QXIOS.0.0.16.0.187 : BOOL:= 0;  (* MOT. NASTRO INTRODUZ. NASTRATRICE *)
	MM AT %QXIOS.0.0.16.0.130 : BOOL:= 0;  (* mot. friz. a valle nastratrice *)
	MN AT %QXIOS.0.0.16.0.164 : BOOL:= 0;  (* mot. traverso *)
	MNCONS AT %QXIOS.0.0.16.0.197 : BOOL:= 0;
	MO AT %QXIOS.0.0.16.0.160 : BOOL:= 0;  (* mot. finale al plz *)
	MP AT %QXIOS.0.0.16.0.165 : BOOL:= 0;  (* mot. catene trslaz. *)
	MQ AT %QXIOS.0.0.16.0.155 : BOOL:= 0;  (* mtz. isola2 *)
