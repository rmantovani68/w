CONFIGURATION LABOCOS2_CONTROL
 ...
 VAR_GLOBAL
	...
	FC3 AT %IXIOS.0.0.16.0.11 : BOOL:= 0;  (* fot. passo-passo da isola2 *)
	FC4 AT %IXIOS.0.0.16.0.12 : BOOL:= 0;
	FCB AT %IXIOS.0.0.16.0.33 : BOOL:= 0;  (* fot. pareggiatore *)
	FCB1 AT %IXIOS.0.0.16.0.10 : BOOL:= 0;
	FCB2 AT %IXIOS.0.0.16.0.9 : BOOL:= 0;
	...
	FCV AT %IXNULL : BOOL:= 0;
	FCW AT %IXNULL : BOOL:= 0;
	...
	PSTOP AT %IXNULL : BOOL:= 0;  (* pulsante di stop *)
	...
	SELPP AT %IXNULL : BOOL:= 0;  (* selettore di accumulo passo-passo dei tre nastri dal secondo piano *)
	...
	C29 AT %QXIOS.0.0.16.0.198 : BOOL:= 0;  (* motore centralina idraulica ELEVATORE *)
	...
	EVNASA AT %QXNULL : BOOL:= 0;  (* elettr. nastro alto *)
	...
	M11 AT %QXIOS.0.0.16.0.176 : BOOL:= 0;  (* mot. curva *)
	M13 AT %QXIOS.0.0.16.0.182 : BOOL:= 0;  (* dorsale corsie C e D *)
	M31 AT %QXIOS.0.0.16.0.200 : BOOL:= 0;
	M32 AT %QXIOS.0.0.16.0.201 : BOOL:= 0;
	M33 AT %QXIOS.0.0.16.0.202 : BOOL:= 0;
	M9 AT %QXIOS.0.0.16.0.170 : BOOL:= 0;
	MA AT %QXIOS.0.0.16.0.169 : BOOL:= 0;
	MB AT %QXIOS.0.0.16.0.203 : BOOL:= 0;
	MC AT %QXIOS.0.0.16.0.208 : BOOL:= 0;  (* motore nastro basculante *)
	MD AT %QXNULL : BOOL:= 0;
	ME AT %QXIOS.0.0.16.0.177 : BOOL:= 0;  (* mot. pareggiatore *)
	MG AT %QXIOS.0.0.16.0.179 : BOOL:= 0;  (* mot. dei 2 espulsori bilancia *)
	MH AT %QXIOS.0.0.16.0.180 : BOOL:= 0;  (* mot. dopo frizionato con espulsore *)
	MI AT %QXIOS.0.0.16.0.178 : BOOL:= 0;  (* mot. friz. a monte nastratrice *)
	ML AT %QXIOS.0.0.16.0.186 : BOOL:= 0;  (* MOT. NASTRO INTRODUZ. NASTRATRICE *)
	MM AT %QXIOS.0.0.16.0.192 : BOOL:= 0;  (* mot. friz. a valle nastratrice *)
	MN AT %QXIOS.0.0.16.0.193 : BOOL:= 0;  (* mot. traverso *)
	MO AT %QXIOS.0.0.16.0.135 : BOOL:= 0;  (* mot. finale al plz *)
	MP AT %QXIOS.0.0.16.0.194 : BOOL:= 0;  (* mot. catene trslaz. *)
	MQ AT %QXIOS.0.0.16.0.199 : BOOL:= 0;  (* mtz. isola2 *)
	MR AT %QXIOS.0.0.16.0.162 : BOOL:= 0;  (* curva isola2 *)
	MS AT %QXIOS.0.0.16.0.163 : BOOL:= 0;
	MT AT %QXIOS.0.0.16.0.165 : BOOL:= 0;  (* mot. isola1 *)
	MU AT %QXIOS.0.0.16.0.168 : BOOL:= 0;  (* mot. isola1 *)
	MW AT %QXIOS.0.0.16.0.164 : BOOL:= 0;  (* curva isola1 *)
	MZ AT %QXIOS.0.0.16.0.166 : BOOL:= 0;  (* mot isola1 *)
