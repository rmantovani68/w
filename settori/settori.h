...
#define MAX_PKL	        64	/* numero max di moduli PKL presenti */
#define MAX_RIGHE_PKL		64
#define MAX_COLONNE_PKL	64

#define MAX_MOD	        32	/* numero max di moduli CAN presenti */
#define MAX_RIGHE_MOD		32
#define MAX_COLONNE_MOD	32
