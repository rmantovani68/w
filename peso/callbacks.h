...
void
on_dlg_plc_msg_pb_ok_clicked           (GtkButton       *button,
                                        gpointer         user_data);

void
on_dlg_edit_collo_pb_qta_errata_clicked
                                        (GtkButton       *button,
                                        gpointer         user_data);

void
on_dlg_edit_collo_pb_riga_mancante_clicked
                                        (GtkButton       *button,
                                        gpointer         user_data);

void
on_dlg_edit_collo_pb_inversione_clicked
                                        (GtkButton       *button,
                                        gpointer         user_data);

void
on_dlg_edit_collo_pb_riga_non_richiesta_clicked
                                        (GtkButton       *button,
                                        gpointer         user_data);

void
on_dlg_edit_collo_pb_annulla_errore_clicked
                                        (GtkButton       *button,
                                        gpointer         user_data);

void
on_dlg_edit_collo_pb_lettura_barcode_id_clicked
                                        (GtkButton       *button,
                                        gpointer         user_data);

void
on_dlg_lettura_barcode_id_entry_barcode_id_activate
                                        (GtkEditable     *editable,
                                        gpointer         user_data);

void
on_dlg_lettura_barcode_id_pb_inserisci_barcode_clicked
                                        (GtkButton       *button,
                                        gpointer         user_data);

void
on_dlg_lettura_barcode_id_pb_ok_clicked
                                        (GtkButton       *button,
                                        gpointer         user_data);


void
on_main_window_pb_collo_flbri_forzato_clicked
                                        (GtkButton       *button,
                                        gpointer         user_data);
...
void
on_nb_list_switch_page                 (GtkNotebook     *notebook,
