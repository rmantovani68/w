...
BOOL SetVarValue(int  nVarIndex, int nValue)
{
	...
	nRC=SendCmd(CMD_SET,szBuffer,TRUE);
	/*
	 * LG 24-05-2010: eliminato perche' inutile?
	 */
	//usleep(25000);
	return nRC;
}
...
*/
BOOL PrintFileLandscape(char *szFile,char *szPrinter,char *szTitle,int nPrintType,BOOL bDelete)
{
	char szCommand[2048];
	char szBuffer[128];
	BOOL bHtml2PS=FALSE;
