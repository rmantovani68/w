...
extern DBSTRUCT tOrdiniBertello_B;  /* Ordini Bertello B */
extern DBSTRUCT tOrdiniBertello_C;  /* Ordini Bertello C */ 
extern DBSTRUCT tOrdiniBertello_R;  /* Ordini Bertello R */ 
extern DBSTRUCT tColliBertello_B;   /* Colli Bertello B */
extern DBSTRUCT tColliBertello_C;   /* Colli Bertello C */ 
extern DBSTRUCT tColliBertello_R;   /* Colli Bertello R */ 
extern DBSTRUCT tRigheBertello_B;   /* Righe Bertello B */
extern DBSTRUCT tRigheBertello_C;   /* Righe Bertello C */ 
extern DBSTRUCT tRigheBertello_R;   /* Righe Bertello R */ 
