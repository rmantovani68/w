...
<center>
	...
	<td bgcolor=#6090b0 align=center><Font color=white size=5><B>LISTA CODICI PRELEVATI</B></td>
</center>
</table>
...
<?php
	...
	printf("<div align=\"center\"><center> <form method=\"get\" action=\"codici_prelevati.php3\"> <table border=\"0\" cellpadding=\"5\" cellspacing=\"5\">");
	...
	if($CB_DA_ANNO>0){
		...
		*                 (e' retroattiva)
		*/
		$szBuffer=sprintf("select r.rpcdpro,a.prdescr,sum(r.rpqtspe) from rig_stor r, ord_stor o, articoli a 
											where r.rpcdpro=a.prcdpro and r.ordprog=o.ordprog and o.opdteva>='%s' and o.opdteva<='%s' 
											group by a.prcdpro,r.rpcdpro,a.prdescr order by sum(r.rpqtspe) desc;",$szFromDate,$szToDate);
		...
		*/
		...
		if($db->f(2)==0){
			...
			printf("<br><br><table BORDER=1 COLS=3 WIDTH=\"70%%\" BGCOLOR=\"#999999\"><tr><th align=left>CODICE</th><th align=left>DESCRIZIONE</th><th align=left>QUANTITA' PRELEVATA</th></tr>");
			do{
				printf("<tr><td>%s</td><td>%s</td><td>%d</td></tr>",$db->f(0),$db->f(1),$db->f(2));
