...
<center>
	...
	<td bgcolor=#608080 align=center><Font color=white size=5><B>RICERCA ORDINE IN STORICO</b></td>
</center>
</table>

<?php
	printf("<center><FORM method=\"get\" action=\"ordine_storico.php3\">");
	...
	if(strlen($TXT_ORDINE)!=0){
		...
		*/
		if(!$db->next_record()){
			...
			$szBuffer=sprintf("select r.rpcdpro as \"CODICE\",
