<?php
	...
	$szBuffer=sprintf("LISTA CODICI PRELEVATI DAL %04d-%02d-%02d AL %04d-%02d-%02d", $CB_DA_ANNO, $CB_DA_MESE, $CB_DA_GIORNO, $CB_A_ANNO, $CB_A_MESE, $CB_A_GIORNO);

	// $worksheet->write(0, 0, $szBuffer);
	$worksheet->write(0, 0, 'ccc');
